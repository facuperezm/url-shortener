...
export default function LinkItem({ link }: Props) {
  ...
  return (
    <div className="bg-white rounded-md flex flex-col px-4 truncate py-3 mb-2 w-full">
      ...
      <button
        ...
        className={`transition-all ease-in-out duration-200 hover:bg-primary-dark-violet ${
          copy ? "bg-primary-dark-violet" : "bg-primary-cyan"
