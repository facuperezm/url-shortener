  ...
  return (
    <header className="flex flex-row w-full px-6 items-center justify-between text-neutral-grayish-violet text-sm font-bold md:max-w-4xl md:mx-auto">
      <nav className="flex flex-row items-center py-10">
        ...
        <a href="#" className="px-2 ml-6 hidden md:block hover:text-black">
          Features
        </a>
        <a href="#" className="px-2 hidden md:block hover:text-black">
          Pricing
        </a>
        <a href="#" className="px-2 hidden md:block hover:text-black">
          Resources
      ...
      <div className="md:flex flex-row items-center gap-6 hidden">
        ...
        <a
          href="#"
          className="bg-primary-cyan rounded-3xl px-5 py-2 font-bold text-white hover:bg-primary-cyan/[0.9]"
        >
          Sign Up
        </a>
      </div>
